...
- Heartbeat, online/offline и duplicate connection policy относятся к WT-204.
- `participant.joined`, `participant.left` и presence fan-out появятся вместе с authoritative presence.
