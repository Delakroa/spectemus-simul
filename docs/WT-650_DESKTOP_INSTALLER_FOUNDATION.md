...
WT-660 устраняет конфликт desktop gateway с уже занятым `8088`: приложение не
останавливает чужой процесс, а получает свободный порт и использует его в
своей LAN invite-ссылке.
