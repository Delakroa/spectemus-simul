...
| MOV, MKV, AVI, MPEG, TS, WMV, FLV            | Desktop host готовит временную H.264/AAC MP4-копию перед публикацией: это надёжнее, чем зависеть от поддержки контейнера в браузере host-а.                                     |
