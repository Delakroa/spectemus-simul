...
@ConfigurationProperties("spectemus-simul.websocket")
    ...
    public RoomWebSocketProperties {
        ...
        if (presenceTtl.isZero() || presenceTtl.isNegative()) {
            throw new IllegalArgumentException(
                    "spectemus-simul.websocket.presence-ttl must be positive");
        }
        ...
        if (chatRateLimit < 1) {
            throw new IllegalArgumentException(
                    "spectemus-simul.websocket.chat-rate-limit must be positive");
        }
        ...
        if (chatRateWindow.isZero() || chatRateWindow.isNegative()) {
            throw new IllegalArgumentException(
                    "spectemus-simul.websocket.chat-rate-window must be positive");
        }
        ...
        if (hostReconnectGrace.isZero() || hostReconnectGrace.isNegative()) {
            throw new IllegalArgumentException(
                    "spectemus-simul.websocket.host-reconnect-grace must be positive");
        }
    }
}
