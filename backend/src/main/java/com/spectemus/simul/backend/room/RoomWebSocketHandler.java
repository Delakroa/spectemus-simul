...
import com.spectemus.simul.backend.room.RoomRealtimeStore.PresenceOutcome;
import com.spectemus.simul.backend.room.RoomRealtimeStore.PresenceResult;
import com.spectemus.simul.backend.room.RoomCreationStore.StoredRoom;
import com.spectemus.simul.backend.room.RoomServerEvent.ProblemDetails;
...
class RoomWebSocketHandler extends TextWebSocketHandler implements RoomEventPublisher {
    ...
    private static final String CONNECTION_ID_ATTRIBUTE = "spectemusSimul.connectionId";
    ...
    private static final String PROBLEM_TYPE_PREFIX = "https://spectemus-simul.invalid/problems/";
